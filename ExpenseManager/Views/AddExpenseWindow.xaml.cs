    ...
    public partial class AddExpenseWindow : Window {
        ...
        private void PredictButton_Click(object sender, RoutedEventArgs e) {
            ...
            try {
                ...
                string category = vietnamese.RemoveDiacritics(predictor.Predict(vietnamese.RemoveDiacritics(description)).ToLower());
